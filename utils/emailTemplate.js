...
const verificationTemplate= (verifyLink, firstName) => {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hello ${firstName},</p>
                <p>Reset password was requested on your account.</p>
                <p>Please click  on the button below to reset your password:</p>
                <div class="button-container">
                    <a href="${verifyLink}" class="button">Graduate</a>
                </div>
                <p>If you did not request for password, kindly ignore this email.</p>
                <p>Best regards,<br>MR Josh</p>
            </div>
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} . All rights reserved.</p>
...
const changePasswordTemplate=(verifyLink,firstName)=>{
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
module.exports ={ signUPTemplate,verificationTemplate,resetPasswordTemplate,changePasswordTemplate}